...
pick_pos_z      = 7.5   #7.3                                                                #Default height for a pickup.  (studs) down after top homing, for picking a pin from the conveyor belt   [No belt in basic version]
...
pins_scanned = {"ReScan"     : {"counter" : 0 , "location" : [10,  6,    0] , "dataset" : [    0,    0,         0,    0,    0,    0,    0,    0]} , \
                ...
                "Tan 3L"     : {"counter" : 0 , "location" : [18,  6,   20] , "dataset" : [ 1400, 1550,      15.0, 23.0, 13.0, 22.0, 15.0, 26.0]} , \
                "Tan 2L"     : {"counter" : 0 , "location" : [10,  6,   20] , "dataset" : [  950, 1200,      15.0, 23.0, 12.0, 22.0, 12.0, 26.0]} , \
                "Tan 1.5L"   : {"counter" : 0 , "location" : [ 2,  6,   20] , "dataset" : [  750,  900,      15.0, 23.0, 12.0, 22.0, 13.0, 26.0]} , \
